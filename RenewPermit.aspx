<%@ Page Title="Foreign Vehicle Permit" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false"CodeFile="RenewPermit.aspx.vb" Inherits="RenewPermit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  {overflow-x: unset;}
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true">
           ...
           <p class=" w3-text-purple" style="font-size:1.7em;margin-left:0%"><b><%Response.Write(Headername)%></b></p>
  <ul class="progress-indicator" style=" margin-top:10px;">
  <li id="tab1" class="active"> <span class="bubble"></span>General</li>
  <li id="tab2"> <span class="bubble"></span> Owner </li>
  <li id="tab3"> <span class="bubble"></span> Driver </li>
  <li id="tab4"><span class="bubble"></span> Vehicle </li>
  <li id="tab5"><span class="bubble"></span> Compulsory Motor Insurance  </li>
  <li id="tab6"> <span class="bubble"></span> Submit </li>
</ul>
...
<script type="text/javascript">
    ...
    function tab4() {
        ...
        document.getElementById("form6").className = "text-dark w3-animate-right pl-5 w3-hide";
...
<div id="form1" class="w3-animate-right fill  pl text-dark" >
  <asp:Panel ID="Page0" runat="server">
      
       <div class="w3-container w3-half w3-mobile w3-left">
          <label for="name" class="w3-left">First Name : </label> <br />  
           
               <asp:TextBox ID="txtFname" type="text" class="w3-input w3-border w3-round-large" runat="server" placeholder="First Name" ></asp:TextBox>
               
         </div>  
      

         <div class="w3-container w3-half w3-mobile w3-right">
            <label for="Surname" class="w3-left">Last Name : </label> <br />
              <asp:TextBox ID="txtLname" type="text" class="w3-input w3-border w3-round-large" runat="server" placeholder="Last Name" ></asp:TextBox>
        </div>
           
        <%--<div class="col-md-7 pb-3 ">
                 <asp:TextBox ID="txtPassportExpire" type="PassportExpire" class="w3-input w3-border w3-round-large" runat="server" placeholder="Passport Expire" ></asp:TextBox>
        </div>--%>

         <div class="w3-container w3-half w3-mobile w3-left">
            <label for="Surname" class="w3-left">Email :  </label> <br />
              <asp:TextBox ID="txtLicenseEmail" type="email" class="w3-input w3-border w3-round-large w3-left " runat="server" placeholder="Email"></asp:TextBox>
        </div>    
        ...
        <div class="col-md-7 pb-3">
              <asp:TextBox ID="txtDate" type="BirthDate" class="w3-input w3-border w3-round-large" runat="server" placeholder="Date"></asp:TextBox>
        </div>--%>

     </asp:Panel>
        <div class="pb-0 w3-container w3-half">	
    <div class="ml-5 pt-5 pb-5 mb-5 pr-5" style="margin-top:5%">
           
        <asp:Button ID="btnNext1" class=" w3-right  w3-purple w3-btn w3-round-large w3-large"  runat="server" UseSubmitBehavior=false Text="Next"  />
  </div>
  </div>


    <asp:Label ID="lblcomments0" class="w3-text-red" runat="server"></asp:Label>   
</div>
...
<div id="form2" class="w3-animate-right fill w3-hide text-dark ui-form w3-margin" >

<div class="ui form w3-margin">
<asp:Panel ID="Page1" runat="server">
<div class="fields">

 <asp:UpdatePanel ID="UpdatePanel20" runat="server" class="two wide field ">
    <ContentTemplate>
     ...
     <div class=" six wide field " >
        ...
        <div class=" six wide field " >
          <label for="name" class="w3-left"> ID Card No. :</label>
               <asp:TextBox ID="txtOwnerIdcard" type="text" class="w3-input w3-border w3-round-large" runat="server" placeholder=" ID Card No." ></asp:TextBox>
        </div>

<div class="four wide field ">
          <label for="name" class="w3-left"> Telephone :</label>
         
               <asp:TextBox ID="txtOwnertel" type="text" class="w3-input w3-border w3-round-large" runat="server" placeholder=" Telephone" ></asp:TextBox>
        </div>
        ...
        <div class=" sixteen wide field">
          <label for="name" class="w3-left"> Address :</label>
               ...
               <asp:TextBox ID="txtOwnerAddress" type="text" class="w3-input w3-border w3-round-large" TextMode="MultiLine" runat="server" placeholder=" Address" style="height: 8rem;" ></asp:TextBox>
      </div>
...
<div id="form3" class="w3-animate-right fill w3-hide text-dark ui-form w3-margin"><%--margin-left:10%--%>

<h2 class="ui dividing header w3-left w3-text-purple" style="position:relative;">
  <b>Main Driver</b>
</h2>
...
<div class="fields">
  ...
  <asp:UpdatePanel ID="UpdatePanel3" runat="server" class="two wide field ">
    <ContentTemplate>
...
<div class="fields" style="margin-top:2rem;">
 ...
 <div class="four wide field">
          <label for="name" class="w3-left ">Nationality : </label> 
 ...
 <div class="six wide field">
            <label for="Surname" class="w3-left">Driver License No. </label>
                 <asp:TextBox ID="txtIdcardDriver" type="Address" class="w3-input w3-border w3-round-large" runat="server" placeholder="Driver License No." ></asp:TextBox>
        </div>

         <div class="six wide field">
            <label for="Expire License" class="w3-left ">Driver License Expiry Date : </label>
          ...
          <div class="six wide field" >
            <label for="Surname" class="w3-left ">BirthDate : </label>
                 <asp:TextBox ID="txtDate" type="txtDate" class="w3-input w3-border w3-round-large" runat="server" placeholder="BirthDate"  ></asp:TextBox>
        </div>
        ...
        <div class="sixten wide field" style="margin-top:2rem;">
            <label for="Surname" class="w3-left ">Address : </label>
                 <asp:TextBox ID="txtAddress" type="Address" class="w3-input w3-border w3-round-large" TextMode="MultiLine" runat="server" placeholder="Address" style=" height:4rem;"  ></asp:TextBox>
        </div>
...
<div class="fields" style="margin-top:2rem;">
 ...
 <div class="six wide field">
            <label for="Surname" class="w3-left ">Passport No. : </label>
                 <asp:TextBox ID="txtPassport" type="txtPassport" class="w3-input w3-border w3-round-large" runat="server" placeholder="Passport"   ></asp:TextBox>
        </div>

        <div class="six wide field" >
            <label for="Surname" class="w3-left ">Passport Expiry : </label>
                 <asp:TextBox ID="txtPassportExpire" type="text" class="w3-input w3-border w3-round-large" runat="server" placeholder="Passport Expiry" ></asp:TextBox>
        </div>
   ...
   <div class="ui stackable two column  grid" style="margin-top:2rem;">
    ...
    <div class="w3-left fields">
          <label for="name" class="w3-left">Passport <i class="fa fa-info-circle w3-button" onclick="document.getElementById('imgEX').style.display='block'" aria-hidden="true"></i> </label>
             <div id="imgEX" class="w3-modal">
    <div class="w3-modal-content w3-crad3 w3-round w3-round-xlarge" style="width: 30%;height: auto;">
      <div class="w3-container">
        <span onclick="document.getElementById('imgEX').style.display='none'" class="w3-button w3-display-topright">&times;</span>
     
        <div class=" w3-container  w3-margin">
        <p>Suggest: photo size 300 kb</p>
        <img src="image/PassportEx.jpg" style=" width:300px; height:200px"/>
        </div>
      </div>
    </div>
           ...
           <ContentTemplate>
          <asp:FileUpload ID="FileUpload1" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadPassport').click();" />
            ...
            <asp:Image ID="PhotoPassport" runat="server" Height="150px" Width="200px"/>
       ...
       <div class="w3-left fields">
          <label for="name" class="w3-left">Driver License <i class="fa fa-info-circle w3-button" onclick="document.getElementById('imgEX2').style.display='block'" aria-hidden="true"></i></label>
             <div id="imgEX2" class="w3-modal">
   <div class="w3-modal-content w3-crad3 w3-round w3-round-xlarge " style="width: 30%;height: auto;">
        <div class="w3-container">
        <span onclick="document.getElementById('imgEX2').style.display='none'" class="w3-button w3-display-topright">×</span>
     
        <div class=" w3-container w3-margin">
        <p>Suggest: photo size 300 kb</p>
        <img src="image/DriverEx.jpg" style=" width:300px; height:200px">
        </div>
    </div>
    </div>
        </div>  
           ...
           <ContentTemplate>
          <asp:FileUpload ID="FileUpload3" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadLicense').click();" />
...
<div class="fields">
  <asp:UpdatePanel ID="Updateprename2" runat="server" class="two wide field ">
    <ContentTemplate>
...
<div class="fields" style="margin-top:2rem;">
 <div class=" eight wide field">
         ...
         <div class="eight wide field">
            <label for="Expire License" class="w3-left ">Passport Expire : </label>
       ...
       <div class="fields" style="margin-top:2rem;">
        <div class=" eight wide field">
            <label for="Surname" class="w3-left ">Address : </label>
                 <asp:TextBox ID="txtAddress2" type="Address" class="w3-input w3-border w3-round-large" runat="server" placeholder="Address" TextMode="MultiLine" style=" height:4rem" ></asp:TextBox>
        </div>
        ...
        <div class="four wide field">
         ...
         <%--<div class="w3-left fields">
            <label for="Surname" class="w3-left fields">State : </label>
                 <asp:TextBox ID="txtState2" type="Address" class="w3-input w3-border w3-round-large" runat="server" placeholder="State" ></asp:TextBox>
        </div>
--%>
    <%--     <div class="w3-left fields">
            <label for="Surname" class="w3-left fields">Province : </label>
                 <asp:TextBox ID="txtCounty2" type="Address" class="w3-input w3-border w3-round-large" runat="server" placeholder="County" ></asp:TextBox>
        </div>
--%>
         <div class="four wide field">
          <label for="name" class="w3-left">Country : </label>
  ...
  <div class="fields" style="margin-top:2rem;">
    ...
    <div class="w3-left fields">
          <label for="name" class="w3-left">Passport <i class="fa fa-info-circle w3-button" onclick="document.getElementById('imgEX').style.display='block'" aria-hidden="true"></i></label>
           ...
           <ContentTemplate>
          <asp:FileUpload ID="FileUploadPassport2" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadPassport2').click();" />
            ...
            <asp:Image ID="PhotoPassport2" runat="server" Height="150px" Width="200px"/>
       ...
       <div class="w3-left fields">
          <label for="name" class="w3-left">Driver License <i class="fa fa-info-circle w3-button" onclick="document.getElementById('imgEX2').style.display='block'" aria-hidden="true"></i></label>
           ...
           <ContentTemplate>
          <asp:FileUpload ID="FileUploadLicense2" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadLicense2').click();" />
            ...
            <asp:Image ID="PhotoLicense2" runat="server" Height="150px" Width="200px"/>
...
<div class="fields">
  <asp:UpdatePanel ID="Updateprename3" runat="server" class="two wide field ">
    <ContentTemplate>
...
<div class="fields" style="margin-top:2rem;">
 <div class=" eight wide field">
  ...
  <div class="fields" style="margin-top:2rem;">
        ...
        <div class=" eight wide field">
            <label for="Surname" class="w3-left">Address : </label>
                 <asp:TextBox ID="txtAddress3" type="Address" TextMode="MultiLine" class="w3-input w3-border w3-round-large" runat="server" placeholder="Address" style=" height:4rem"></asp:TextBox>
        </div>
       ...
       <%--  <div class="w3-left fields">
            <label for="Surname" class="w3-left fields">State : </label>
                 <asp:TextBox ID="txtState3" type="Address" class="w3-input w3-border w3-round-large" runat="server" placeholder="State" ></asp:TextBox>
        </div>
--%>
     <%--    <div class="w3-left fields">
            <label for="Surname" class="w3-left fields">Province : </label>
                 <asp:TextBox ID="txtCounty3" type="Address" class="w3-input w3-border w3-round-large" runat="server" placeholder="County" ></asp:TextBox>
        </div>--%>
   ...
   <div class="ui stackable two column  grid" style=" margin-top: 2rem;">
    ...
    <div class="w3-left fields">
          <label for="name" class="w3-left">Passport <i class="fa fa-info-circle w3-button" onclick="document.getElementById('imgEX').style.display='block'" aria-hidden="true"></i></label>
           ...
           <ContentTemplate>
          <asp:FileUpload ID="FileUploadPassport3" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadPassport3').click();" />
            ...
            <asp:Image ID="PhotoPassport3" runat="server" Height="150px" Width="200px"/>
       ...
       <div class="w3-left fields">
          <label for="name" class="w3-left">Driver License <i class="fa fa-info-circle w3-button" onclick="document.getElementById('imgEX2').style.display='block'" aria-hidden="true"></i></label>
           ...
           <ContentTemplate>
          <asp:FileUpload ID="FileUploadLicense3" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadLicense3').click();" />
            ...
            <asp:Image ID="PhotoLicense3" runat="server" Height="150px" Width="200px"/>
...
<div id="form4" class=" w3-animate-right fill w3-hide text-dark ui-form w3-margin">
...
<div class=" fields">
         <div class="eight wide field">
          <label for="name" class="w3-left">Registration No. (ENG) : </label>
         <asp:TextBox ID="txtLicenseCar" type="Registration No." class="w3-input w3-border w3-round-large" runat="server" placeholder="Registration No. (ENG)" ></asp:TextBox>
          ...
          <div class=" eight wide field">
          <label for="name" class="w3-left">Registration No. (Local) : </label>
 ...
 <asp:Panel id="pnLao2" runat="server">    
    <asp:UpdatePanel ID="UpdatePanel5" runat="server"   >
    <ContentTemplate>
    <div class=" fields">
       <div class=" eight wide field">
          <label for="name" class="w3-left">Country of registration : </label>
          <asp:DropDownList ID="ddlCountryCar" runat="server" class="w3-input w3-border w3-round-large" AutoPostBack="true"> 
            </asp:DropDownList>
        </div>
        
         <div class=" eight wide field">
          <label for="name" class="w3-left">Province of registration : </label>
          <asp:DropDownList ID="ddlProvinceRegis" runat="server" class="w3-input w3-border w3-round-large"> 
            </asp:DropDownList>
        </div>
    </div>
...
<div class=" fields" style="margin-top:2rem;">
         <div class="four wide field">
            <label for="Surname" class="w3-left">Make : </label>
                  <asp:TextBox ID="txtBrands" type="brands" class="w3-input w3-border w3-round-large" runat="server" placeholder="Make" ></asp:TextBox>
        </div>

      <%--  <div class="col-ml-2 pl-5 w3-left">
            <label for="Surname">Passport Vehicle : </label>
        </div>    
        <div class="col-md-7 pb-3 ">
                  <asp:TextBox ID="txtPassportCar" type="brands" class="w3-input w3-border w3-round-large" runat="server" placeholder="Passport Vehicle" ></asp:TextBox>
        </div>
--%>
 <%--       <div class="col-ml-2 pl-5 w3-left">
            <label for="Surname">Expire Passport Vehicle : </label>
        </div>    
        <div class="col-md-7 pb-3 ">
                  <asp:TextBox ID="txtPassportCarExpire" type="brands" class="w3-input w3-border w3-round-large" runat="server" placeholder="Expire Passport Vehicle" ></asp:TextBox>
        </div>
--%>
        <div class="four wide field">
          <label for="name" class="w3-left">Model : </label>
...
<%--
        ...
        <div class="col-md-7 pb-3">
               <asp:TextBox ID="txtYears" type="text" class="w3-input w3-border w3-round-large" runat="server" placeholder="Years" ></asp:TextBox>
        </div>--%>

        <div class="four wide field">
          <label for="name" class="w3-left">Colors : </label>
            <asp:DropDownList ID="ddlColor" runat="server" class="w3-input w3-border w3-round-large"> 
            </asp:DropDownList>
        </div>

        <div class="four wide field">
          <label for="name" class="w3-left">Seating (Driver included) : </label>
 ...
 <div class=" fields" style="margin-top:2rem;">
    <div class="four wide field">
          <label for="name" class="w3-left">Vehicle Identification Number (VIN) : </label>
...
<%-- <asp:Panel id="pnLao2" runat="server">    
    ...
    <ContentTemplate>
      ...
      <asp:AsyncPostBackTrigger ControlID="ddlCountryCar" EventName="SelectedIndexChanged" />
       ...
       <div class="four wide field">
          <label for="name" class=" w3-left">Engine Number : </label>
            ...
            <div class="four wide field">
          <label for="name" class=" w3-left">Engine Capacity (CC) : </label>
        ...
        <div class="col-md-4 pb-3">
         <asp:TextBox ID="txtNumcar" type="Serial Car" class=" w3-input  w3-border w3-round-large" runat="server" placeholder="VIN Number" ></asp:TextBox>
          ...
          <div class="four wide field">
          <label for="name" class=" w3-left">Gross Weight (kg.) : </label>
    ...
    <div class=" fields" style="margin-top:2rem;">
           <div class=" eight wide field">
          <label for="name" class="w3-left">Vehicle Registration Certificate : </label>
         

         
           <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="conditional"  ChildrenAsTriggers="true">
           <ContentTemplate>
          <asp:FileUpload ID="FileUpload4" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadRegisCar').click();" />
            ...
            <asp:Image ID="PhotoRegisCar" runat="server" Height="150px" Width="200px"/>
        ...
        <div class="eight wide field">
          <label for="name" class="w3-left">Letter of Consent from Vehicle Owner / Authorization from Vehicle Owner : </label>
           ...
           <ContentTemplate>
          <asp:FileUpload ID="FileUpload6" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadAuthorize').click();" />
            ...
            <asp:Image ID="PhotoAuthorize" runat="server" Height="150px" Width="200px"/>
...
<div class="ui stackable column  grid" style="margin-top:2rem;">
    
            <label for="name" class="w3-left"><b>Vehicle Photos : </b></label>
<div class="w3-left fields">
           ...
           <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="conditional"  ChildrenAsTriggers="true" class="eight wide field">
           <ContentTemplate>
          <asp:FileUpload ID="FileUpload2" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadCar').click();" />
...
<div id="form5" class="w3-animate-right fill w3-hide text-dark ui-form w3-margin">
...
<div class=" fields">
        ...
        <div class=" eight wide field">
        <label for="name" class=" w3-left">Insurance Company :</label>
        ...
        <div class="eight wide field">
          <label for="name" class=" w3-left">Policy Number : </label>
        ...
        <div class="eight wide field">
         ...
         <div class="eight wide field">
          ...
          <asp:FileUpload ID="FileUpload5" runat="server" onchange="document.getElementById('ContentPlaceHolder1_btnUploadAct').click();" />
            ...
            <asp:Image ID="PhotoAct" runat="server" Height="150px" Width="200px"/>
...
<div class="col-md-3 w3-left" id="divMap" >

            <iframe runat="server" id="iframeMap" enableviewstate="true" frameborder="0" name="IframeLocation" scrolling="yes" 
 ...
 || navigator.userAgent.match(/Windows Phone/i)
              ...
              var iFrame = document.getElementById("ContentPlaceHolder1_iframeMap");
      ...
      function get_IframeMaps(pro) {
          document.getElementById('ContentPlaceHolder1_iframeMap').src = 'Map/MapArea.aspx?pro=' + pro;
      }
      function get_IframeMap(pro) {
          document.getElementById('ContentPlaceHolder1_iframeMap').src = document.getElementById('ContentPlaceHolder1_iframeMap').src + ',' + pro;
      }

      function get_IframeMapDel(pro) {
          document.getElementById('ContentPlaceHolder1_iframeMap').src = document.getElementById('ContentPlaceHolder1_iframeMap').src.replace("," + pro, "");
      }
    </script>
...
<br /><br /><br /><br />
 ...
 <asp:DropDownList ID="ddlProvarea" runat="server" class="w3-input w3-border w3-round-large"> 
            ...
            <div class=" w3-text-purple mt-2 " onclick="document.getElementById('ContentPlaceHolder1_btnProv').click();"> <i class="fa fa-2x fa-plus-circle" aria-hidden="true"></i></div>
            </asp:Panel> 
 </div>
...
<asp:Button ID="btnPrev5" class=" w3-center w3-purple w3-btn w3-round-large w3-large mr-4"  runat="server" UseSubmitBehavior=false Text="Prev" />
         <asp:Button ID="btnSave" class=" w3-center w3-purple w3-btn w3-round-large w3-large ml-4"   runat="server" UseSubmitBehavior=false Text="Save" />
            <button class=" w3-right w3-purple w3-btn w3-round-large w3-large ml-4"   onclick ="Submit();return false;" UseSubmitBehavior=false>Submit</Button>
            <br />
