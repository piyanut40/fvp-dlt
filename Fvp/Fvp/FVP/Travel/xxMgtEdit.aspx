<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageC.master" AutoEventWireup="false" CodeFile="xxMgtEdit.aspx.vb" Inherits="Travel_xxMgtEdit" %>
      ...
      <div class="fields" style="margin-top:2rem;">
        ...
        <div class="six wide field" style="font-family: 'Kanit', sans-serif;font-size: small;">
          <label for="name" class="w3-left">Email : </label>
                  <asp:TextBox ID="txtLicenseEmail" type="email" class="w3-input w3-border w3-round-large" runat="server" placeholder="Email" ></asp:TextBox>
            </div>
