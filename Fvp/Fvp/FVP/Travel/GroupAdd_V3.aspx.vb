...
Imports Npgsql
Imports System.IO
Partial Class Travel_GroupAdd_V3
    ...
    Private Sub LoadDataRenew()
        ...
        Try
            ...
            Dim dtGuide As DataTable = dbConnect.getDataTable("select ord_id , user_prename , user_name , user_lastname , telephone, idcard " & _
                                                              " from user_travel_group where group_id = " & Request.QueryString("id"), "ddd")
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            Try
                _status = dbConnect.executeScalar("select coalesce(status_id,0) from license where license_id = (select license_id from travel_group_car where group_id = " & Request.QueryString("id") & ")")
                If _status = 2 Then
                    ddlBorderCheckin.Enabled = False
                    ddladmin.Enabled = False
                    lnkSchMap.Visible = False
    ...
    Protected Sub Provarea_Delete(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        ...
        Else
            ...
            If prov_code = 0 Then
                ...
                For Each row As GridViewRow In gvProv.Rows
                    gvProv.Rows.Item(0).FindControl("ProvareaDelete").Visible = False
                Next
    ...
    Protected Sub BtnBorderCheckOut_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnBorderCheckOut.Click
        ...
        Dim db As New DBConnect
        Dim oldprov As String = tbProvice.Rows(0)("prov_code")
        If tbProvice.Rows.Count > 1 Then
            tbProvice.Rows(1).Delete()
        End If
