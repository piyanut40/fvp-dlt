<%@ Page Language="VB" AutoEventWireup="false" CodeFile="XCarAdd.aspx.vb" MasterPageFile="~/MasterPageC.master" Inherits="Travel_XCarAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <h4 class="headtxt"><b>Apply for a Permit</b></h4>
</div>
...
<script type="text/javascript">
    ...
    function tab_active(_tab) {
        ...
        var _tab_active = "nav-link active w3-purple2";
...
<div class="container col-12  position-relative w3-padding w3-white w3-padding-top32">
 ...
 <asp:HiddenField ID="hidspare_driver_id1" runat="server" />
 <asp:HiddenField ID="hidspare_driver_id2" runat="server" />
