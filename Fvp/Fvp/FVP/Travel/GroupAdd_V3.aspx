<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageC.master" AutoEventWireup="false" CodeFile="GroupAdd_V3.aspx.vb" Inherits="Travel_GroupAdd_V3" %>
...
<div class=" six wide field" style="font-family: 'Kanit', sans-serif;font-size: small;" align="left">
   ...
   <asp:HyperLink ID="hlFilePDF" runat="server" Cssclass="btn-link w3-text-purple" >[hlFilePDF]</asp:HyperLink>&nbsp;
