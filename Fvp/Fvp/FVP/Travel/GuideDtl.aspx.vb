...
Partial Class Travel_GuideDtl
    ...
    Private Sub LoadGuide()
        ...
        Try
            con.Open()
            cmd.Connection = con
            cmd.CommandText = "select guide.* , regis_no , regis_photo " & _
            " from travel_group_guide inner join guide on guide.guide_id = travel_group_guide.guide_id " & _
            " WHERE gid = " & Request.QueryString("gid") & " And guide.travel_user_id = " & Session("user_id")
