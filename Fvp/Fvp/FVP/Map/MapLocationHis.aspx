<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MapLocationHis.aspx.vb" Inherits="Map_MapLocationHis" %>
...
//        }
    ...
    var mLayerCars;
    function AddMarkerCar(x, y, textPopup, typecar_id, type, license_id) {
        var type_icon = '';
        var _width = 32;
//        alert(typecar_id);
        if (typecar_id != -1) {
        ...
        var marker = L.marker(new L.LatLng(y, x), { icon: mIconCar, draggable: false }).addTo(mLayerCars); //.bindPopup(textPopup);
...
<script type="text/javascript">
    ...
    function AddProvince(polylinePro) {
        ...
        var polygon = new L.geoJson(polylinePro, { renderer: myRenderer }).addTo(mLayerCars);
    }
...
<body id="mBody" runat="server">
   <form id="form1" runat="server">
    ...
    <div id="over_map_rights" style="z-index:420;" runat="server" >
        ...
        <tr>
                        ...
                        <td align="left">
                            <asp:Label ID="lblname_company" runat="server" Text="-"></asp:Label>
                        </td>
                    </tr>
        <tr>
                        <td align="right" style="width: 120px">
                    ...
                    <tr>
                        <td align="right" style="width: 120px">
                             <asp:Label ID="lblHeads" runat="server" Text="ผู้นำเที่ยว : "></asp:Label>&nbsp; 
                        </td>
                        <td align="left">
                               <asp:Label ID="lblguide" runat="server" Text="-"></asp:Label>
                        </td>
                    </tr>
                     <tr>
                        <td align="right" style="width: 120px">
                ...
                <asp:ListItem Value="1" Text="อยู่ในเส้นทาง"></asp:ListItem>
                <asp:ListItem Value="2" Selected="True" Text="ออกนอกเส้นทาง"></asp:ListItem>
                </asp:DropDownList> 
                        </td>
                    </tr>
                ...
                <asp:ListItem Value="" Text="เลือกทั้งหมด" Selected="True"></asp:ListItem>
                    ...
                    <tr>
                        <td align="right" style="width: 160px" valign="top">
                            เลขที่เครื่องหมาย : &nbsp;<br /> แสดงการใช้รถ &nbsp;  &nbsp;
                        </td>
                        <td align="left">
