...
Partial Class Map_MapAdmin
    ...
    Protected Sub BtnUpdateDataMarker_Click(sender As Object, e As System.EventArgs) Handles BtnUpdateDataMarker.Click
...
#End Region
    ...
    Protected Sub btnSetAdmin_Click(sender As Object, e As System.EventArgs) Handles btnSetAdmin.Click
        Dim script = " winOpener=window.self.opener; " & _
                         " winOpener.document.getElementById('ContentPlaceHolder1_HidValueddladmin').value='" & HidAdminID.Value & "' ; " & _
                         " winOpener.document.getElementById('ContentPlaceHolder1_btnSetValueddladmin').click() ; " & _
                         " window.close(); "
