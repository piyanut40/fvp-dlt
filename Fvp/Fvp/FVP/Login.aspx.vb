...
Partial Class Login
    ...
    Protected Sub LinkButton1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles LinkButton1.Click
        ...
        Try
            ...
            Dim DataTable = db.ReadDataTable(str)
            Dim DataTable2 = db.ReadDataTable(strUserLocal)
            ...
            ElseIf DataTable2.Rows.Count > 0 Then
                ...
                Dim drTable As DataTable = db.ReadDataTable("select CAST(fname || ' ' || lname as varchar) as name , typeuser_id from license WHERE email = '" & txtUsername.Text & "'")
                Session("user_id") = dr("user_id")
                ...
                Response.Redirect("Local/index.aspx", True)
            Else
                Dim datatableadmin = db.getDataTable(strAdmin, "admin")
                Dim datatableuseradmin = db.getDataTable(strUserAdmin, "user_admin")
                If datatableadmin.Rows.Count > 0 Or datatableuseradmin.Rows.Count > 0 Then
                    ...
                    Else
                        If datatableuseradmin.Rows.Count > 0 Then
                            ...
                            Table = db.getDataTable("SELECT user_admin.admin_id , user_admin.username, type, admin.admin_name from user_admin left join admin on admin.admin_id = user_admin.admin_id WHERE user_admin.username like '" & txtUsername.Text & "' ", "tableadmin")
                        ...
                        Else
                            Dim Table As New DataTable
                            Table = db.getDataTable("SELECT admin_id , username , admin_name from admin WHERE username like '" & txtUsername.Text & "' ", "tableadmin")
                            Session("admin_id") = Table.Rows(0)(0).ToString
                            Session("user_id") = Table.Rows(0)(1).ToString
                ...
                ElseIf txtUsername.Text.Trim.IndexOf("admin#") > -1 And txtPassword.Text.Trim = "admin1234" Then
                    ...
                    Dim DataTableAdminTest = db.getDataTable(strAdminTest, "admintest")
