...
Partial Class Admin_arrival
    ...
    Protected Sub gvMain_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvMain.RowDataBound
        ...
        Try
            ...
            Else
                ...
                Dim lnkDel As HyperLink = e.Row.Cells(19).FindControl("HyperLinkDel")
                Dim lblLicense As Label = e.Row.Cells(0).FindControl("lblLicense")
                Dim lblToken As Label = e.Row.Cells(0).FindControl("lbltoken")
                Dim lblold_group_id As Label = e.Row.Cells(0).FindControl("lblold_group_id")
                Dim lblreceipt_no As Label = e.Row.Cells(0).FindControl("lblreceipt_no")
                Dim HyperDoc As HyperLink = e.Row.Cells(11).FindControl("HyperPDF")
                Dim HyperDoc1 As HyperLink = e.Row.Cells(13).FindControl("HyperDoc")
                Dim HyperSign As HyperLink = e.Row.Cells(12).FindControl("HyperSign")
                ...
                Dim Hyperplan As HyperLink = e.Row.Cells(9).FindControl("Hyperplan")
                ' Hyperplan.Attributes.Add("onclick", "javascript:ResetActive(" & lblLicense.Text & ");")

                Hyperplan.NavigateUrl = "javascript:window.open('MapPop.aspx?no=" & lbllicense_no.Text & "" & _
                                  "','L11','scrollbars=yes,resizable=1,width=1002,height=798').focus();"
                Dim lnkPay As HyperLink = e.Row.Cells(12).FindControl("HyperPay")
                lnkPay.Attributes.Add("onclick", "javascript:Pay(" & lblLicense.Text & ");")

                Dim lnkPDFNew As HyperLink = e.Row.Cells(12).FindControl("HyperPDFNew")
                ...
                Dim lnkRegist As HyperLink = e.Row.Cells(18).FindControl("HyperRegist")
                ...
                Else
                    If lblreceipt_no.Text.Trim <> "" Then
                        lnkPay.Visible = False
    ...
    Protected Sub BtnReceipt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnReceipt.Click
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "INSERT INTO receipt( license_id , receipt_no , receipt_date , receipt_pc , receipt_process , registrar_name , registrar_position , unit) " & _
