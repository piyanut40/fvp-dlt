<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="false" CodeFile="RptStatChartAll_6.aspx.vb" Inherits="Admin_RptStatChartAll_6" %>
  ...
  <div id="divShowDate" class="w3-row w3-padding "> 
    ...
    <ContentTemplate>
     <asp:Button class="w3-button w3-purple2 w3-padding w3-round" id="BtnSch" onclick="BtnSch_Click" runat="server" UseSubmitBehavior="false" Text="ค้นหา" > </asp:Button>
          ...
          <br /><asp:Label ID="Label1" runat="server" Text="จำนวนรถที่ได้รับอนุญาตเข้ามาในราชอาณาจักรเป็นการชั่วคราว จำแนกตามประเทศที่รถจดทะเบียน"  Font-Size="18" ForeColor="#333333"></asp:Label> 
          </div>
