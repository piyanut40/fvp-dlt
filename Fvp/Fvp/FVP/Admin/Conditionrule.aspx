<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Conditionrule.aspx.vb" MasterPageFile="~/MasterPageB.master" Inherits="Conditionrule" %>


<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <header class="w3-container" style="margin-top: 10px;margin-bottom: 5px;">
<a ><b style="font-size:1.5em;margin-left:0%;font-family: 'Kanit', sans-serif;">จัดการข้อมูลฝ่าฝืนเงื่อนไข</b></a>
</header><br />
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <div class="w3-row w3-padding-small"> 
            ...
            <div class="w3-col l2">
            <asp:TextBox ID="txtName" class="w3-input w3-border w3-round-large"  placeholder="เลขที่เครื่องหมายแสดงการใช้รถ" oninput="document.getElementById('MainContent_BtnSch').click();" runat="server"></asp:TextBox>
            </div>

             <div  class="w3-col l8 w3-right-align">

             <asp:LinkButton ID="lnkAdd" class="w3-button w3-purple2 w3-padding w3-round" runat="server"><i class="fa fa-plus" aria-hidden="true" ></i>  เพิ่มข้อมูลการฝ่าฝืนเงื่อนไข</asp:LinkButton>
            </div>
          </div><br />
    ...
    <asp:TemplateField Visible="false">
        <ItemTemplate>
            <asp:Label ID="lbl_consid" runat="server" Text='<%# eval("cond_id")%>'></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
         <asp:BoundField DataField="num" HeaderText="<center>No.</center>" ItemStyle-HorizontalAlign="Center"  HtmlEncode="False" ItemStyle-Width="80" />

         <asp:BoundField DataField="license_no" HeaderText="<center>เลขที่เครื่องหมาย<br />แสดงการใช้รถ</center>"    HtmlEncode="False" ItemStyle-Width="100" />
         <asp:BoundField DataField="con_rule" HeaderText="<center>ข้อกำหนดการฝ่าฝืนเงื่อนไข</center>"  HtmlEncode="False"/>
         <asp:BoundField DataField="cond_time" HeaderText="<center>วันที่ฝ่าฝืนเงื่อนไข</center>" ItemStyle-HorizontalAlign="Center"  HtmlEncode="False" DataFormatString="{0:d MMM yyyy}" ItemStyle-Width="100"/>
         <asp:TemplateField HeaderText="<center>จัดการข้อมูล<br />การฝ่าฝืนเงื่อนไข </center>" ItemStyle-Width="120"  ItemStyle-HorizontalAlign="Center">
                 <ItemTemplate>
          ...
          <asp:TemplateField HeaderText="<center>ลบข้อมูล<br />การฝ่าฝืนเงื่อนไข</center>" ItemStyle-Width="120" ItemStyle-HorizontalAlign="Center" >
                                    <ItemTemplate>
