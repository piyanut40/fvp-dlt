<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPagePopup.master" AutoEventWireup="false" CodeFile="RptStatChartAll_3.aspx.vb" Inherits="Admin_RptStatChartAll_3" %>
...
<%--For Chart--%>
  ...
  <%--<div class="w3-col l2_2 w3-right-align w3-padding-top w3-padding-right">
            &nbsp;&nbsp;&nbsp;
            </div>--%>
    ...
    <ContentTemplate>
     <asp:Button class="w3-button w3-purple2 w3-padding w3-round" id="BtnSch" onclick="BtnSch_Click" runat="server" UseSubmitBehavior="false" Text="ค้นหา" > </asp:Button>
          ...
          <br /><asp:Label ID="Label1" runat="server" Text="ด่านศุลกากรที่อนุญาตรถผ่านเข้า-ออก " ForeColor="#333333" Font-Size="18"></asp:Label> 
          </div>
