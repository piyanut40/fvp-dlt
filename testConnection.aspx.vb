...
Partial Class testConnection
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim Dt As DataTable = dbconect.getDataTable(TextBox1.Text, "data1")
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Dim Dt As DataTable = dbconect.ReadDataTable(TextBox2.Text)
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Response.Write("<br /> 2. getConnection - State: " & con.State.ToString())
        Try
            'con.ClearPool()
            Npgsql.NpgsqlConnection.ClearPool(con)
            cmd.Connection = con
            cmd.Connection.Open()
            Response.Write("<br /> 3. Connection.Open()  - State: " & con.State.ToString())
    ...
    Private Sub getData()
        ...
        Finally
            ' ✅ ตรวจสอบและปิด Connection อย่างปลอดภัย
