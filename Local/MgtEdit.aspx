<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MgtEdit.aspx.vb" MasterPageFile="~/MasterPageC.master" Inherits="Local_MgtEdit" %>
...
<b class="w3-text-purple" style="position:relative;font-family: 'Kanit', sans-serif;padding-bottom: .21428571rem;border-bottom: 2px solid rgba(34,36,38,.15);margin-left: 6%;font-size: x-large;margin-top: -35px;">
 Owner
</b>
</div>
...
<div class="fields" style="margin-top:2rem; margin-left: 5%;">
      ...
      <div class="fields" style="margin-top:2rem; margin-left: 5%;">
        ...
        <div class="three wide field" style="font-family: 'Kanit', sans-serif;font-size: small;">
          <label for="name" class="w3-left">Email : </label>
                  <asp:TextBox ID="txtOwnerEmail" type="email" class="w3-input w3-border w3-round-large" runat="server" placeholder="Email" ></asp:TextBox>
            </div>
...
<div class="ui stackable four column grid " style="font-family: 'Kanit', sans-serif;">
 ...
 <div class="w3-left fields col-md-3 pb-3" style="font-family: 'Kanit', sans-serif;font-size: small;">
   ...
   <div class="ui stackable three column grid">
     <div class="w3-left fields col-md-1 pb-3"></div>
          <div class="w3-left fields col-md-5 pb-3" style="font-family: 'Kanit', sans-serif;font-size: small;">
          <label for="name" class="w3-left">Certified translation of vehicle driver license (If applicable) : </label>
          <br />&nbsp;
...
<div class="ui stackable four column grid" >
 ...
 <div class="w3-left fields col-md-3 pb-3" style="font-family: 'Kanit', sans-serif;font-size: small;">
   ...
   <div class="w3-left fields col-md-1 pb-3"></div>
    <div class="w3-left col-md-5 fields" style="font-family: 'Kanit', sans-serif;font-size: small;">
          <label for="name" class="w3-left">Passport ( jpg or png and size of attached file not over 5 MB) : </label>
       <br />&nbsp;
...
<div class="ui stackable four column grid ">
   <div class="w3-left fields col-md-1 pb-3 "></div>
           ...
           <%--<div class="w3-left fields col-md-5 pb-3 w3-left-align" style="font-family: 'Kanit', sans-serif;font-size: small;">--%>
          <label for="name">Vehicle Registration Certificate <br />( jpg or png and size of attached file not over 5 MB)  : </label>
         <%--</div>    
        ...
        <div class="w3-left fields col-md-5 pb-3 w3-left-align" style="font-family: 'Kanit', sans-serif;font-size: small;">
        <%--<div class="w3-left fields col-md-5 pb-3 w3-left-align" style="font-family: 'Kanit', sans-serif;font-size: small;">--%>
          <label for="name">Letter of Consent from Vehicle Owner / Authorization from Vehicle Owner <br />( jpg or png and size of attached file not over 5 MB)  : </label>
         <%--</div>    
        <div class="w3-left fields col-md-5 pb-3" >--%>
...
<div class="ui stackable four column grid ">
   <div class="w3-left fields col-md-1 pb-3 "></div>
     <div class="w3-left fields col-md-5 pb-3 w3-left-align" style="font-family: 'Kanit', sans-serif;font-size: small;">
          <label for="name">Certified translation of vehicle registration (If applicable) : </label>
         <%--</div>    
        <div class="w3-left fields col-md-3 pb-3">--%>
           <asp:UpdatePanel ID="UpdatePanelPhotoCarCer" runat="server" UpdateMode="conditional"  ChildrenAsTriggers="true">
           <ContentTemplate>
          <asp:FileUpload ID="FileUploadPhotoCarCer" runat="server" onchange="document.getElementById('MainContent_btnUploadPhotoCarCer').click();" />
            <asp:ImageButton ID="btnUploadPhotoCarCer" style="DISPLAY: none"  runat="server" AutoPostBack="true" ImageUrl="~/image/upload.png" Width="50px"  OnClientClick="showProgress();" UseSubmitBehavior="false" />
               <asp:HiddenField ID="hidPhotoCarCer" runat="server" />
            <asp:Image ID="PhotoCarCer" runat="server"  Height="200px" Width="250px"/>
            <asp:ImageButton ID="PhotoDeleteCarCer"  OnClientClick="javascript:return confirm('Do you want delete photo?'); return false;"  ImageUrl="../image/g_delete.gif"  runat="server"
             alt="Delete" title="Delete" UseSubmitBehavior="false" Visible="false" />
            </ContentTemplate>
                  <Triggers>
                      <asp:PostBackTrigger ControlID="btnUploadPhotoCarCer"/>
	          </Triggers>
           </asp:UpdatePanel>
...
<div class="w3-left fields col-md-1 pb-3 "></div>
 ...
 <div class="w3-left fields col-md-7 pb-5 w3-left-align" style="font-family: 'Kanit', sans-serif;font-size: small;">
           <label for="name">Vehicle Photos ( jpg or png and size of attached file not over 5 MB)  : </label>
           <%--</div> 
        <div class="w3-left fields col-md-3 pb-3">--%>
        <br />
        <div class="w3-left fields col-md-4 pb-3 w3-left-align">
          ...
          <%--      <asp:ListItem Text="Right Side" Value="4"></asp:ListItem>--%>
            ...
            <div class="w3-left fields col-md-6 pb-3">
...
<div class="w3-left fields col-md-1 pb-3 "></div-->
    ...
    <asp:UpdatePanel ID="UpdgvFile" runat="server" class="w3-row-padding w3-center" UpdateMode="Conditional" style="font-family: 'Kanit', sans-serif;font-size: small; margin-left:5.5%; margin-top:-20px; ">
                    <contenttemplate>
...
<div class="w3-left fields col-md-1 pb-3 "></div>
           ...
           <div class="w3-left fields col-md-5 pb-3 w3-left-align" style="font-family: 'Kanit', sans-serif;font-size: small;">
          <label for="name">Policy Schedule ( jpg or png and size of attached file not over 5 MB)  : </label>
         <%--</div>    
        <div class="w3-left fields col-md-3 pb-3" style="font-family: 'Kanit', sans-serif;font-size: small;" >--%>
