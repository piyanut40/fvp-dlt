...
Partial Class EditTravel
    ...
    Private Sub savedata()
        ...
        Try
            ...
            cmd.CommandText = "select username , pass from user_travel WHERE user_id = '" & Session("user_id") & "' and username = '" & Session("username") & "' "
            ...
            If dr.Read Then
                ...
                Else
                    ...
                    cmd.CommandText = "Update user_travel set pass=:pass where username = '" & lblUser.Text & "'"
