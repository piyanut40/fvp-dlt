<%@ Page Title="Foreign Vehicle Permit" Language="VB" MasterPageFile="~/MasterPage.Master" AutoEventWireup="false"CodeFile="Register.aspx.vb" Inherits="Register" %>
...
<script type="text/javascript">
    ...
    function alertDataOld() {
        $.confirm({
            ...
            buttons: {
                confirm: function () {
                    document.getElementById('ContentPlaceHolder1_btnLoaddata').click();
                },
                cancel: function () {
                    //$.alert('Cancel');
                }
    ...
    function alertalready() {
        ...
        $.confirm({
            title: 'Notification ',
            content: 'Email is already , go to login ?',
            buttons: {
                Yes: function () {
                    document.getElementById('ContentPlaceHolder1_btnGotoLogin').click();
                },
                No: function () {
                    //$.alert('Cancel');
                }
    ...
    function alertDataDriver() {
        $.confirm({
            title: 'Notification ',
            content: 'Is driver the same as owner? ',
            buttons: {
                Yes: function () {
                    document.getElementById('ContentPlaceHolder1_btnLoadDriver').click();
                },
                No: function () {
                    //$.alert('Cancel');
                }
...
<asp:Button ID="btnGotoLogin" UseSubmitBehavior=false runat="server" style="DISPLAY: none" Text="Button" />
      ...
      <div class="fields" style="margin-top:2rem;">
        ...
        <div class="six wide field">
         ...
         <%--   <asp:ListItem Value="Myanmar" Text="Myanmar"></asp:ListItem>
          ...
          <asp:Button ID="btnPrev1" class="w3-purple w3-btn w3-round-large w3-left w3-large" style="display:none"  runat="server" UseSubmitBehavior=false Text="Prev" />
</div>
</div>
  ...
  <label for="Prename" class="w3-left">Title : </label>
    ...
    <div class="seven wide field ">
          <label class="w3-left">First name : </label>
            ...
            <asp:TextBox ID="txtName" type="Name" class="w3-input w3-border w3-round-large" runat="server" placeholder="First name" ></asp:TextBox>
     </div> 
...
<div class="fields">
  <asp:UpdatePanel ID="Updateprename2" runat="server" class="two wide field ">
    ...
    <div class="seven wide field">
          <label class="w3-left">First name : </label>
            <asp:TextBox ID="txtName2" type="Name" class="w3-input w3-border w3-round-large" runat="server" placeholder="First name" ></asp:TextBox>
...
<div class="seven wide field">
          <label class="w3-left">First name : </label>
            <asp:TextBox ID="txtName3" type="Name" class="w3-input w3-border w3-round-large" runat="server" placeholder="First name" ></asp:TextBox>
