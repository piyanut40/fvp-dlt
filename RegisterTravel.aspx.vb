            ...
            Try
                ...
                Else
                    ...
                    If hidlat.Value = "" Or hidlon.Value = "" Then
                        strthe_geom = " null "
                    End If
                    Dim strInsert = "Insert INTO user_travel (name_company , user_name , user_surname , idcard , telephone , tumbol , amphoe , " & _
                                  " province , postal , lat , lon , email , facebook , line , company_license , address , user_type , username , pass , the_geom , is_active , license_photo , license_exp )" & _
                                  " VALUES (:name_company , :user_name , :user_surname , :idcard  ,  :telephone , :tumbol , :amphoe , " & _
