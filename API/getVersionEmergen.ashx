<%@ WebHandler Language="VB" Class="getVersionEmergen" %>
...
Public Class getVersionEmergen : Implements IHttpHandler
    
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
      
        Dim emergen_sql As String = "SELECT MAX(emergen_ver) as ver from emergency"
        Dim db As New DBConnect
        Dim dtTask As DataTable = db.getDataTable(emergen_sql, "Version")
