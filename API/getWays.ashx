<%@ WebHandler Language="VB" Class="getWays" %>
...
Public Class getWays : Implements IHttpHandler
    
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
       
        Dim Way As String = " SELECT way_name , ku_type" & _
                             " FROM public.aec_way " & _
                             " WHERE way_sub = 2 and ku_type like '%t%' "
        Dim db As New DBConnect 
        Dim dtTask As DataTable = db.getDataTable(Way, "Way")
