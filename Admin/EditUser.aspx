<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditUser.aspx.vb" MasterPageFile="~/MasterPageB.master" Inherits="EditUser" %>


<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">

  <header class="w3-container" style="margin-top: 10px;margin-bottom: 5px;">
<a ><b style="font-size:1.5em;margin-left:0%;font-family: 'Kanit', sans-serif;">จัดการข้อมูลสมาชิก/ผู้ประกอบธุรกิจนำเที่ยว</b></a>
</header>
...
<br />
   ...
   <div class="w3-row w3-padding-small"> 
            ...
            <div class="w3-col l2">
            <asp:TextBox ID="txtName" class="w3-input w3-border w3-round-large"  placeholder="ข้อมูลสมาชิก/บริษัทท่องเที่ยว" oninput="document.getElementById('MainContent_BtnSch').click();" runat="server"></asp:TextBox>
            </div>
         ...
         <Columns>
           <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                          ...
                                          <asp:Label id="lbltype" runat="server" Text='<%# eval("user_type") %>'></asp:Label>
          ...
          <asp:BoundField DataField="number" HeaderText="<center>No.</center>" ItemStyle-Width="60px" 
             ...
             <asp:BoundField DataField="user_name" HeaderText="<center>ชื่อสมาชิก</center>" 
                 HtmlEncode="False" />

             <asp:BoundField DataField="name_company" HeaderText="<center>ชื่อผู้ประกอบธุรกิจนำเที่ยว</center>" HtmlEncode="False" />

             <asp:BoundField DataField="username" HeaderText="<center>Username</center>" HtmlEncode="False" />

            

             <asp:BoundField DataField="active_name" HeaderText="<center>สถานะ</center>" HtmlEncode="False" ItemStyle-HorizontalAlign="Center" />
             ...
             <asp:TemplateField HeaderText="<center>เปลี่ยน<br/>สถานะ </center>" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
...
<script type="text/javascript" language="javascript" >
    ...
    function ResetActive(Del_ID, Del_Type , Active) {
        var Msg;
        if (Active == 0) {
            Msg = 'คุณต้องการเปลี่ยนสถานะบัญชีผู้ใช้ให้เป็น Active ใช่หรือไม่?';
        }
        else {
            Msg = 'คุณต้องการเปลี่ยนสถานะบัญชีผู้ใช้ให้เป็น Not Active ใช่หรือไม่?';
        }
    ...
    function ResetPass(Del_ID, username) {
