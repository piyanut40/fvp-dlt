<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageB.master" AutoEventWireup="false" CodeFile="RptStatCarByAdmin_Car.aspx.vb" Inherits="Admin_RptStatCarByAdmin_Car" %>
...
<div class="w3-card-4 w3-margin w3-white " style="max-width:1500px">
  ...
  <div  class="w3-row w3-padding w3-right"> 
    <a href="javascript:void(0)" class="w3-button w3-purple2 w3-padding w3-round"  onclick="document.getElementById('<%=BtnExportExcel.ClientID %>').click();" >Export Excel ข้อมูลการอนุญาตรถท่องเที่ยว</a>
               <asp:LinkButton ID="btnBack" runat="server"  class="w3-button w3-purple2 w3-padding w3-round" PostBackUrl="RptStatChartData.aspx"  >ย้อนกลับ</asp:LinkButton>             
  </div>

<div class="w3-container w3-content w3-center w3-padding-4" style="max-width:800px" >
             <div  class="w3-row w3-padding w3-center" > 
              <asp:Label ID="lblHead" runat="server" Text="รายงานการอนุญาตรถเข้ามาในราชอาณาจักรชั่วคราว จำแนกตามคำขอฯ" Font-Bold="True" Font-Size="20"></asp:Label> 
              </div> 
    ...
    <ContentTemplate>
     <asp:Button class="w3-button w3-purple2 w3-padding w3-round" id="Button1" onclick="BtnSch_Click" runat="server" UseSubmitBehavior="false" Text="ค้นหา" > </asp:Button>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>   
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" ShowExportControls = "false">
                </rsweb:ReportViewer>
            </ContentTemplate>
        </asp:UpdatePanel>
