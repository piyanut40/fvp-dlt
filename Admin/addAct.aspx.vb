...
Partial Class addAct
    ...
    Protected Sub btnNext4_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext4.Click
        ...
        Try
            ...
            cmd.Parameters.Add("act_tankno", NpgsqlTypes.NpgsqlDbType.Varchar).Value = DBNull.Value
            ...
            cmd.ExecuteNonQuery()
            cmd.CommandText = CommandType.Text
            cmd.CommandText = "UPDATE license set status_id = 1 WHERE token = '" & Request.QueryString("token") & "'"
            cmd.ExecuteNonQuery()
        Catch ex As Exception
        ...
        Finally
            ...
            con.Close()
            Response.Redirect("arrival.aspx?rt=" & Request.QueryString("rt"))
        End Try
