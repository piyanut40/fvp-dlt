...
Partial Class Admin_RptStatChartAll_6
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            If Request.QueryString("rt") = 1 Then
                lblHead.Text = "ข้อมูลประเทศที่จดทะเบียนรถประจำถิ่น"
            ElseIf Request.QueryString("rt") = 2 Then
                lblHead.Text = "ข้อมูลประเทศที่จดทะเบียนรถท่องเที่ยว"
            End If
            loadChart()
        End If
    End Sub
    ...
    Private Sub loadChart()
        ...
        Dim table_2 As Table = PopulateChart.AddTable(Page, 13, typeuser_id, _year, lblHead, txtsdate, txtedate, 0, ddldate.SelectedValue)
        If IsMobile Then
        ...
        tr = New TableRow
        tc = New TableCell
        Dim divChart14 As String = "<br /><br /><div id='container14' " & styleChart & " ></div> <br /><br />"
        tc.BorderColor = Drawing.Color.DarkGray
        ...
        _data = PopulateChart.getDataChart(Page, "coalesce(type_car.type_name_th,'ไม่ระบุ') as car_type , coalesce(car.country_car,'ไม่ระบุ') ", 14, typeuser_id, _year, txtsdate, txtedate, 0, ddldate.SelectedValue)
        pScriptAddChart = pScriptAddChart & _data & " AddChart12(_data,_categories,'container14',true,'จำนวนรถที่ได้รับอนุญาตฯ จำแนกตามประเทศที่รถจดทะเบียน และประเภทรถ'); "
    ...
    Private Function LoadDataExport(ByVal IsExcel As Boolean) As DataTable
        ...
        Dim dtChart As DataTable = PopulateChart.ConvertDataExport(Page, 13, Request.QueryString("rt"), _year, lblHead, txtsdate, txtedate, _limit, IsExcel, ddldate.SelectedValue)
        Return dtChart
    End Function
    ...
    Protected Sub BtnDownloadCSV_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnDownloadCSV.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=myChart" & 13 & ".csv")
    ...
    Protected Sub BtnDownloadExcel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnDownloadExcel.Click
        ...
        Response.AddHeader("content-disposition", "attachment;filename=myChart" & 13 & ".xls")
        Response.Charset = ""
        ...
        headerTable = "<table border=1><tr><td colspan=" & cntColumns & "><center><b>รถที่ได้รับอนุญาตเข้ามาในราชอาณาจักร<b></center></td></tr><tr>" & _
